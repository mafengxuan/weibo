    ...
    <form class="form form-horizontal" id="art_form" action="{{url('admin/permission/'.$data->id)}}" method="post">
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text"  placeholder="" id="" name="name" value="{{$data->name}}">
            </div>
        </div>
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>权限描述：</label>
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text"  placeholder="" id="" name="description" value="{{$data->description}}">
            </div>
        </div>
